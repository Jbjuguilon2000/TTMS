        ...
        <tbody>
            ...
            while ($r = $trainingQuery->fetch_assoc()) {
                ...
                echo "<tr>
                        ...
                        <button type='button' class='btn btn-outline-danger btn-sm' data-bs-toggle='modal' data-bs-target='#deleteTrainingModal' onclick='deleteConfirmation($ID)'><i class='bi bi-trash-fill'></i></button>
                        </td>
                    </tr>";
            }
            ?>
